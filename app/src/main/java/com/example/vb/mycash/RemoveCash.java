...
public class RemoveCash extends AppCompatActivity {
    ...
    public void CashRemove(View view)
    {
        ...
        databesehelper.addExpenses(new Cash(new CategoriesCash(cat_id, cat_name),0,cash,note,oneDD));
        finish();
    ...
    public void AdapterSpinner()
    {
        ...
        String[] data = new String[mainActivity.categoriesExpenses.size()];
        for(int i=0; i<data.length;i++)
        {
            data[i] = mainActivity.categoriesExpenses.get(i).categorie;
        }
        // адаптер
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view,
                ...
                cat_id = position;
                cat_name = mainActivity.categoriesExpenses.get(cat_id).categorie;
            }
            @Override
